...
func Get(ctx context.Context, selector string) v1alpha1.ClusterTriggerAuthenticationInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/kedacore/keda/v2/pkg/generated/informers/externalversions/keda/v1alpha1.ClusterTriggerAuthenticationInformer with selector %s from context.", selector)
	}
